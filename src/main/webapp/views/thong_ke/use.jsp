...
<head>
    ...
    <meta property="og&#x3A;url" content="&#x2F;&#x2F;t0239.store.nhanh.vn">
            ...
            <div class="top-header d-flex align-items-center container-fluid">
                ...
                <div class="logo text-center">
                    <a href="/" class="d-block">
                        <img src="https://pos.nvncdn.com/eb9ddb-116318/store/20220301_M6gPcIeoQ8cwvJrojaQ7a688.png" alt="logo-t0239.store.nhanh.vn">
                    </a>
                </div>
                    ...
                    <div class="d-none d-lg-flex justify-content-center">
                        <ul class="nav menu-pc justify-content-center">
                            <li class="lv1 cate_hover">
                                ...
                                <ul class="wrap">
                                    <li class="lv2">
                                        <a class="tp_menu_item" href="/phu-kien-pc570539.html">Phụ kiện
                                        </a>
                            ...
                            <li class="lv1 cate_hover">
                                <a class="tp_menu_item nav-top-link d-inline-block  font-weight-bold position-relative" href="/giay-pc570537.html" title="Giày">Giày</a>
                                <i class="fas fa-caret-down"></i>
                                <ul class="wrap">
                                    <li class="lv2">
                            ...
                            <li class="lv1 cate_hover">
                                <a class="tp_menu_item nav-top-link d-inline-block  font-weight-bold position-relative" href="/ki-gui-pc571352.html" title="Kí gửi">Kí gửi</a>
                            </li>
                            <li class="lv1 cate_hover">
                                <a class="tp_menu_item nav-top-link d-inline-block  font-weight-bold position-relative" href="/quan-ao-pc571353.html" title="Quần áo">Quần áo</a>
                            </li>
                            <li class="lv1 cate_hover">
                                <a class="d-inline-block font-weight-bold position-relative tp_menu" href="/news" title="Tin tức">Tin tức</a>
                            </li>
                            <li class="lv1 cate_hover">
                                <a class="d-inline-block font-weight-bold position-relative tp_menu" href="/promotion" title="Khuyến mại">Khuyến mại</a>
                            </li>
                            <li class="lv1 m-0 position-relative">
                                <form action="/search" method="get" class="d-flex form-group position-relative m-0" role="search">
                                    <input type="text" name="q" placeholder="Tìm kiếm sản phẩm" class="button_gradient form-control text-center py-0">
                                    <button type="submit" class="btn p-0">
                                        <span class="fas fa-search"></span>
                                    </button>
                                </form>
    ...
    <div id="signin-signup" class="margin-page signin-signup">
        <div class="head-page">
            <div class="container-pre">
                <h1 class="text-uppercase font-weight-bold mb-0 text-center">My Account</h1>
            </div>
        </div>
        <div class="container-pre content-signin">
            <div class="row">
                <div id="customer-login" class="col-md-6 form-login">
                    <h2 class="font-weight-bold title text-uppercase">Đăng nhập</h2>
