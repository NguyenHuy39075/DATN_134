    ...
    <div class="d-flex">
        ...
        <div class="pt-3" style="width: calc(100% - 250px);">
            <div class="container">
                    ...
                    <div>
                        <table class="table table-bordered table-hover table-striped mt-5">
                            ...
                            <c:forEach items="${data}" var="hd">
                                <%--                                onclick="location.href='detail?id=${hd.id}'"--%>
                                <tr>
                                    <td>${hd.id}</td>
                                    <td>${hd.ngayLap}</td>
                    ...
                    <div class="modal-dialog modal-lg" role="document"> <!-- Thêm lớp modal-lg để mở rộng kích thước -->
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="/ban-hang/inserthdct" method="post">
                                    <input type="hidden" name="hoaDonId" value="${hoaDonId}"/> <!-- Hoặc giá trị thực tế -->
                                    <input type="number" name="ctspId" required />
                                    <input type="number" name="soLuong" required />
                                    <input type="number" name="donGio" required />
                                    <input type="number" name="thanhTien" required />
                                    <table class="table table-bordered table-hover table-striped mt-5">
                                        <thead>
                                        <tr><th>Ma CTSP</th><th>Ten San Pham</th><th>So Luong</th><th>Mau Sac</th><th>Size</th><th>Chat Lieu</th><th>Don Gia</th><th>Anh san pham</th><th>TT</th></tr>
                                        </thead>
                                        <tbody>
                                        <c:forEach items="${dataSP}" var="sp">
                                            <tr>
                                                ...
                                                <td>${sp.donGia}</td>
                                                <td><input type="number" name="soLuong" value="${sp.soLuong}"></td>
                                                <td>
                ...
                <%--                                    <!-- Modal Header -->--%>
                <%--                                    <div class="modal-header">--%>
                <%--                                        <h4 class="modal-title">Nhap so luong san pham</h4>--%>
                <%--                                        <button type="button" class="close" data-dismiss="modal">&times;</button>--%>
                <%--                                    </div>--%>

                <%--                                    <!-- Modal body -->--%>
                <%--                                    <div class="modal-body">--%>
                <%--                                        <p>SL<input type="number" name="soLuong"></p>--%>
                <%--                                    </div>--%>

                <%--                                    <!-- Modal footer -->--%>
                <%--                                    <div class="modal-footer">--%>
                <%--                                        <button type="button" class="btn btn-danger" data-dismiss="modal">Them</button>--%>
                <%--                                    </div>--%>
